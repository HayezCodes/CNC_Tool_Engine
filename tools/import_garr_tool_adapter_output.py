"""Import Garr Tool adapter output into the Enterprise Tooling Search index."""
...
ADAPTER_OUTPUT = _REPO_ROOT / "tools" / "tooling_adapters" / "output" / "garr_tool_sample_records.json"
DEFAULT_OUTPUT = RECORDS_DIR / "garr_tool_imported_tools.json"
