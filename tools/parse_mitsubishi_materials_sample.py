"""Runner script: parse the Mitsubishi Materials sample JSON fixture.

Parses tools/tooling_adapters/samples/sample_mitsubishi_materials_structured.json,
...
from tools.tooling_adapters.mitsubishi_materials_adapter import parse_mitsubishi_file
...
def run(output_path: Path, dry_run: bool = False) -> int:
    ...
    # ── Parse ─────────────────────────────────────────────────────────────────
    result = parse_mitsubishi_file(SAMPLE_JSON)
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Parse the Mitsubishi Materials sample JSON fixture and write normalized JSON output."
    )
    parser.add_argument(
        "--output",
