"""Runner: parse the Seco Tools sample JSON fixture.
...
SAMPLE_JSON = _REPO_ROOT / "tools" / "tooling_adapters" / "samples" / "sample_seco_structured.json"
DEFAULT_OUTPUT = _REPO_ROOT / "tools" / "tooling_adapters" / "output" / "seco_sample_records.json"


def run(output_path: Path, dry_run: bool = False) -> int:
    result = parse_seco_tools_file(SAMPLE_JSON)
