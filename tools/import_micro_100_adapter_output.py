"""Import Micro 100 adapter output into the Enterprise Tooling Search index."""
...
ADAPTER_OUTPUT = _REPO_ROOT / "tools" / "tooling_adapters" / "output" / "micro_100_sample_records.json"
DEFAULT_OUTPUT = RECORDS_DIR / "micro_100_imported_tools.json"
