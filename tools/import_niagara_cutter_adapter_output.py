"""Import Niagara Cutter adapter output into the Enterprise Tooling Search index."""
...
ADAPTER_OUTPUT = _REPO_ROOT / "tools" / "tooling_adapters" / "output" / "niagara_cutter_sample_records.json"
DEFAULT_OUTPUT = RECORDS_DIR / "niagara_cutter_imported_tools.json"
