"""Sumitomo Electric structured JSON adapter for the Enterprise Tooling Search system.

Sumitomo Electric Hardmetal Corporation is a Japanese cutting tool manufacturer.
Key product families: AC/WBN/EH grade turning inserts, SEXL/SNEX milling inserts,
MDW modular drills, solid carbide endmills, GY grooving inserts, threading inserts,
and high-feed LNMX inserts.
...
class SumitomoElectricAdapter(BaseToolingAdapter):
    """Parse Sumitomo Electric-style structured JSON tooling records into normalized records."""

    SOURCE_FORMAT = "sumitomo_electric_json"
...
def parse_sumitomo_electric_file(source: str | Path) -> dict[str, Any]:
    """Parse a Sumitomo Electric structured JSON file and return a result summary dict."""
