"""Helical Solutions structured JSON adapter for the Enterprise Tooling Search system.

Helical Solutions (part of Harvey Performance Company) is a US solid carbide endmill
manufacturer. Key product families: 4-flute general endmills, 3-flute aluminum endmills,
5-flute finishing endmills, 7-flute roughers, corner radius endmills, dynamic milling
endmills, drills, and thread mills.
...
_OPERATION_MAP: dict[str, str] = {
    ...
    "finishing": "finishing",
    "roughing": "roughing",
    "semirough": "semi_roughing",
    "semiroughing": "semi_roughing",
    "drilling": "drilling",
...
class HelicalSolutionsAdapter(BaseToolingAdapter):
    """Parse Helical Solutions-style structured JSON tooling records into normalized records."""

    SOURCE_FORMAT = "helical_solutions_json"
...
def parse_helical_solutions_file(source: str | Path) -> dict[str, Any]:
    """Parse a Helical Solutions structured JSON file and return a result summary dict."""
