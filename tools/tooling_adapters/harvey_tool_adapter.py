"""Harvey Tool structured JSON adapter for the Enterprise Tooling Search system.

Harvey Tool Company is a US specialty tooling manufacturer. Key product families:
miniature ball nose endmills, long reach endmills, internal and external thread mills,
reamers, countersinks, drills, and step drills.
...
_TOOL_CATEGORY_MAP: dict[str, str] = {
    ...
    "endmill": "endmill",
    "ballnoseendmill": "endmill",
    "solidcarbidedrill": "drill",
    "spotdrill": "drill",
    "threadmill": "thread_mill",
    "solidcarbidethreadmill": "thread_mill",
    "internalthreadmill": "thread_mill",
    "externalthreadmill": "thread_mill",
    "reamer": "reamer",
...
class HarveyToolAdapter(BaseToolingAdapter):
    """Parse Harvey Tool-style structured JSON tooling records into normalized records."""

    SOURCE_FORMAT = "harvey_tool_json"
...
def parse_harvey_tool_file(source: str | Path) -> dict[str, Any]:
    """Parse a Harvey Tool structured JSON file and return a result summary dict."""
