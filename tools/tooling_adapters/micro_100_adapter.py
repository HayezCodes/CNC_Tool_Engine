"""Micro 100 structured JSON adapter for the Enterprise Tooling Search system.

Micro 100 Tool Corporation is a US manufacturer specializing in solid carbide boring bars,
grooving tools, and threading tools. Key product families: solid carbide boring bars,
external grooving inserts, face grooving, external threading, thread mills, endmills,
and countersinks.
...
_TOOL_CATEGORY_MAP: dict[str, str] = {
    ...
    "solidcarbideboringbar": "boring_bar",
    "groovinginsert": "grooving_insert",
    "externalgroovinginsert": "grooving_insert",
    "facegroovingtool": "grooving_insert",
    "threadinginsert": "threading_insert",
    "externalthreadinginsert": "threading_insert",
...
class Micro100Adapter(BaseToolingAdapter):
    """Parse Micro 100-style structured JSON tooling records into normalized records."""

    SOURCE_FORMAT = "micro_100_json"
...
def parse_micro_100_file(source: str | Path) -> dict[str, Any]:
    """Parse a Micro 100 structured JSON file and return a result summary dict."""
    adapter = Micro100Adapter()
