"""Garr Tool structured JSON adapter for the Enterprise Tooling Search system.

Garr Tool is a US solid carbide cutting tool manufacturer. Key product families:
4-flute square endmills, 2-flute aluminum endmills, ball nose endmills, roughing
endmills, solid carbide drills, reamers, thread mills, and countersinks.
...
class GarrToolAdapter(BaseToolingAdapter):
    """Parse Garr Tool-style structured JSON tooling records into normalized records."""

    SOURCE_FORMAT = "garr_tool_json"
...
def parse_garr_tool_file(source: str | Path) -> dict[str, Any]:
    """Parse a Garr Tool structured JSON file and return a result summary dict."""
