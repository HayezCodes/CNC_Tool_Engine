"""Runner: parse the Kennametal sample JSON fixture.
...
SAMPLE_JSON = _REPO_ROOT / "tools" / "tooling_adapters" / "samples" / "sample_kennametal_structured.json"
DEFAULT_OUTPUT = _REPO_ROOT / "tools" / "tooling_adapters" / "output" / "kennametal_sample_records.json"


def run(output_path: Path, dry_run: bool = False) -> int:
    result = parse_kennametal_file(SAMPLE_JSON)
