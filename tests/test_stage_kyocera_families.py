...
def test_required_kyocera_families_exist() -> None:
    ...
    assert {"turning_insert", "milling_insert", "grooving_insert", "threading_insert"}.issubset(categories)
    assert {"external_turning", "face_milling", "grooving", "threading"}.issubset(operations)
