"""Integration tests: Helical Solutions adapter → import → audit → review → search."""
from __future__ import annotations
import json
from pathlib import Path

_REPO = Path(__file__).resolve().parent.parent
_ADAPTER_OUTPUT = _REPO / "tools" / "tooling_adapters" / "output" / "helical_solutions_sample_records.json"
_IMPORTED = _REPO / "tool_data" / "tooling_search" / "records" / "helical_solutions_imported_tools.json"
_REVIEWED = _REPO / "tool_data" / "tooling_search" / "records" / "reviewed" / "helical_solutions_reviewed_tooling_records.json"

BRAND = "Helical Solutions"
FORBIDDEN = {"feed", "speed", "sfm", "rpm", "ipr", "ipm", "vc", "fz"}
EXPECTED_MPNS = {
    "FIXTURE-HEL-SCE-001", "FIXTURE-HEL-SCE-002", "FIXTURE-HEL-SCE-003", "FIXTURE-HEL-SCE-004",
    "FIXTURE-HEL-SCE-005", "FIXTURE-HEL-SCE-006", "FIXTURE-HEL-SCD-007", "FIXTURE-HEL-TM-008",
}
...
class TestSearchable:
    ...
    def test_search_by_helical(self):
        from grade_engine.tooling_search import search_tooling_records
        results = search_tooling_records("Helical Solutions")
    ...
    def test_filter_by_brand(self):
        ...
        results = filter_tooling_records(load_tooling_records(), {"brand": "helical"})
